...
- `is_child_of` - folosită în graf.
- `is_married_to` - folosită în graf.
- `is_parent_of` - folosită în graf.
- `is_rival_of` - rezervată de vocabularul controlat.
- `is_sibling_of` - folosită în graf.
- `loves` - rezervată de vocabularul controlat.
- `manipulates` - folosită în graf.
