...
- `opere_pdf/Moara cu noroc - Ioan Slavici.pdf` — textul integral și sursa factuală principală;
- `modele_eseuri/moara_cu_noroc.md` — eseul-model și sursa normativă pentru trăsăturile curentului literar abordate în eseu;
- `cercetare/graf2/knowledge-graph.json` — model structural pentru dimensiunea și ontologia grafului 2 al operei „Ion”, fără a fi folosit ca sursă factuală pentru „Moara cu noroc”.
...
DELIMITAREA OBLIGATORIE A CAPITOLELOR PENTRU „MOARA CU NOROC”

Opera trebuie modelată în exact 17 capitole, în ordinea I-XVII. Nu deduce granițele exclusiv din schimbarea paginii și nu confunda anexele editoriale cu textul nuvelei. Capitolele I și II încep pe aceeași pagină PDF și trebuie separate după marcajele interne `I` și `II`.

În PDF-ul furnizat, delimitarea verificată este:

- Capitolul I: pagina PDF 2, de la marcajul `I` până înaintea marcajului `II`;
- Capitolul II: paginile PDF 2-3, de la marcajul `II`;
- Capitolul III: paginile PDF 4-5;
- Capitolul IV: paginile PDF 6-8;
- Capitolul V: paginile PDF 9-12;
- Capitolul VI: paginile PDF 13-14;
- Capitolul VII: paginile PDF 15-18;
- Capitolul VIII: paginile PDF 19-21;
- Capitolul IX: paginile PDF 22-29;
- Capitolul X: paginile PDF 30-33;
- Capitolul XI: paginile PDF 34-36;
- Capitolul XII: paginile PDF 37-38;
- Capitolul XIII: paginile PDF 39-40;
- Capitolul XIV: paginile PDF 41-47;
- Capitolul XV: paginile PDF 48-49;
- Capitolul XVI: paginile PDF 50-52;
- Capitolul XVII: pagina PDF 53.

Pagina PDF 1 conține coperta și datele de generare, iar pagina PDF 54 conține sursele, contributorii și licența; acestea nu fac parte din narațiunea nuvelei. Fiecare eveniment trebuie atribuit capitolului în care apare efectiv, iar pagina de început și pagina de sfârșit trebuie păstrate în metadatele capitolului.
...
Pentru „Moara cu noroc”, curentul trebuie determinat din surse și modelat ca realism. Eseul-model este sursa normativă pentru trăsăturile care vor fi abordate în eseu. Creează și evidențiază exact aceste două trăsături:

- verosimilitatea evenimentelor prin cronotopul precis;
- interesul pentru psihologia personajelor, demonstrat prin analiza frământărilor lui Ghiță, monolog interior, stil indirect liber și detalii de gestică și mimică.
...
Pentru „Moara cu noroc”, conținutul acestor noduri trebuie să urmeze exact analiza din eseul-model:

- `Relația incipit-final`: simetria prolog-epilog; dialogul inițial dintre Ghiță și bătrână; deschiderea `in medias res`; confruntarea dintre generații și mentalități; dorința tinerilor de „mai bine” opusă valorii tradiționale a mulțumirii; teza morală enunțată prin replica bătrânei; revenirea bătrânei lângă copiii orfani și hanul ars; replica finală despre presimțire și destin.
- `Titlul`: sensul inițial de loc binecuvântat și adăpost norocos pentru drumeți; valea și vizibilitatea din culmea dealului pleșuv; cele cinci cruci; prosperitatea familiei cât timp câștigul este făcut cinstit; transformarea locului în spațiu damnat odată cu influența lui Lică; moartea ca deznodământ al coruperii și focul purificator care distruge cârciuma.
- `Conflictul`: conflictul interior al lui Ghiță între dorința de înavuțire și păstrarea valorilor morale, redat prin monolog interior, stil indirect liber, gestică și mimică; conflictul exterior Ghiță-Lică, construit prin frică, subordonare, dependență financiară, încercarea de desubordonare și răzbunarea finală; degradarea relației Ghiță-Ana ca efect familial al conflictelor.
