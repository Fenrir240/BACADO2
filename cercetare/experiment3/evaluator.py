...
base = _load_module(BASE_EVALUATOR_PATH, "experiment3_base_evaluator")
    ...
    def __init__(self, model_id: str, device: str | None = None) -> None:
        try:
            ...
            raise RuntimeError(
                ...
                "experiment3/requirements.txt înaintea evaluării oficiale."
            ) from exc
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluator pentru Experimentul 3.")
