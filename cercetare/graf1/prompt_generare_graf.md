...
Cele 300 de noduri trebuie să conțină informație reală. Este interzisă atingerea pragului prin:
...
1. `knowledge-graph.json`
   - graful complet;
   - minimum 300 de noduri;
   - minimum 900 de relații.
...
- verifică minimum 300 de noduri;
...
- există minimum 300 de noduri semantice reale;
- există minimum 900 de relații;
